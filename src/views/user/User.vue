...
<script>
  ...
  import NavBar from 'components/common/navbar/NavBar'
    ...
    data() {
		  return {
		    orderList: [
          {icon: '#order', iconColor: '#ff8198', info: '我的消息',image: require('../../assets/img/user/info.png')},
          {icon: '#point', iconColor: '#fc7b53', info: '积分商城',image: require('../../assets/img/user/shop.png')},
          {icon: '#vip', iconColor: '#ffc636', info: '会员卡',image: require('../../assets/img/user/member.png')},
        ],
        serviceList: [
          {icon: '#service', iconColor: '#ff8198', info: '我的购物车',image: require('../../assets/img/user/car.png')},
          {icon: '#download', iconColor: '#ff8198', info: '下载购物APP',image: require('../../assets/img/user/download.png')},
        ]
      }
    },
	}
